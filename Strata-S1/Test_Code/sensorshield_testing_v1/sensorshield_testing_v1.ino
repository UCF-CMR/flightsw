...
**** THIS TEST CODE WILL ONLY TRY TO READ FROM ONE TUBE AT A TIME ****
...
//#define  LC_D_CLK            10    // Tube B Load Cell CLK                          
//#define  LC_D_DOUT            9    // Tube B Load Cell DATA OUT
#define  chipSelect           8    // SDcard chipselect

//#define  LC_D_CLK             7    // Tube D Load Cell CLK                     
//#define  LC_D_DOUT            6    // Tube D Load Cell DATA OUT   
#define  LC_D_CLK             5    // Tube C Load Cell CLK                                          
#define  LC_D_DOUT            4    // Tube C Load Cell DATA OUT            
//#define  "X"                  3    // Not used.  
//#define  "X"                  2    // Not used.   
//#define  "X"                  1    // Not used.
//#define  "X"                  0    // Not used.
...
//#define  FSR_B2               A1   // Tube B FSR 2 data - not used  ***** D2
//#define  FSR_C1               A2   // Tube C FSR 1 data             ***** C2
//#define  FSR_C2               A3   // Tube C FSR 2 data
//#define  FSR_D1               A4   // Tube D FSR 1 data                                
//#define  FSR_D2               A5   // Tube D FSR 2 data             ***** C1                          

#define  FSR_D1               A5   // Tube D FSR 1 data                                
#define  FSR_D2               A2   // Tube D FSR 2 data                              
...
// Set up load cell in Tube B  
  ...
  Serial.println("Tare value LC D:");
...
// In this version only reading from D, placeholder data for B & C
// *** LOAD CELLS *** 
...
// for the test, only read from D, placeholder data for C
  dataString += " ";
  dataString += ",";
  dataString += " ";

  int sensor = analogRead(FSR_D1);
  dataString += String(sensor);
  dataString += ",";
  sensor = analogRead(FSR_D2);
  dataString += String(sensor);
